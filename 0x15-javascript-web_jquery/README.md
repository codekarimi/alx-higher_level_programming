/intranet.hbtn.io/rltoken/JAC2vdSj1pbH6y_9OwQrAw)
...
* [API](https://intranet.hbtn.io/rlto# 0x15. Javascript - Web JQuery
...
* [Get and set content](https:/ken/w_Y67Y3UlGQ6nluZx9KJyQ)
...
<html lang="en">
  <head>
    <titguillaume@ubuntu:~/0x15$ 
```

### [5. List of elements](./5-script.js)
* Write a Javascript script that adds a LI element to a list when the user clicks on the tag DIV#add_item:
* The new element must be: <li>Item</li>
* The new element must be addele>Holberton School</title>
    <script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
  </head>
  <body>
    <header> 
...
guillaume@ubuntu:script" src="101-script.js"></script>
  </head>
  <body>
    <header> 
      First HTML page
