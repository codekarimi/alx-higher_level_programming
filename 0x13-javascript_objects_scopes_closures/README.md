...
* [Object prototypes](httshtag #javascriptisamazing :))
...
### [0. ps://intranet.hbtn.io/rltoken/lrlwnQMM82RimJJcfLao5w)
...
* Why Javascript programming is amazing (don't forget to tweet today, with the haRectangle #0](./0-rectangle.js)
...
const r2 = new Rectangr class
* The constructor must take 2 arguments w and h
* Initialize the instance attribute width with the value of w
* Initialize the instance attribute height with the value of h
* If w or h is equal to 0 or not a positive integer, create an empty objectle(2, -3);
console.log(r2);
...
* Write a class Rectangle that defines a rectangle:
* You must use the class notation for defining you
```
...
undefined
undefined
Rectangle {}const r1 = new Rectangle(2, 3);
console.log(r1);
console.log(r1.width);
console.log(r1.height);
...
```
guilguillaume@ubuntu:~/0x13$ cat 6-main.js
#!/usr/bin/node
...
guillaume@ubuntu:~/0x13$ laume@ubuntu:~/0x13$ cat 8-main.js
#!/usr/bin/node
