...
* If no arguments are passed to the script, print “No argument”
* You must use console.log(...) to print nt all output
* You are not allowed to use var
...
* You must use console.log(...) to prio console.log
* You must use a loop (while, for, etc.)
```
...
* You have to define a function with this prototype: est!](./11-second_biggest.js)
...
console.log(myVar);
guillaume@ubuntufunction add(a, b)
* You must use console.log(...) to print all output
* You are not allowed to use var
```
guillaume@ubuntu:~/0x12$ ./9-add.js 
NaN
guillaume so don’t worry about it.
...
### [11. Second bigg:~/0x12$ ./100-main.js
333
guillaume@ubuntu:~/0x12$ 
```
